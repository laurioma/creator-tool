...
export const getTikTokStats = functions.https.onRequest(async (request, response) => {
  console.log('=== getTikTokStats called ===');
  return corsHandler(request, response, async () => {
    try {
      ...
      console.log('Embed HTML received, length:', html.length);
